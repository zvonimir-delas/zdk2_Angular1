angular.module('myApp').config(function($stateProvider){
    ...
    .state('listAll',{
        ...
        template: `
            ...
            {{student.name}} <button ui-sref="details({studentId: student.id, studentName: student.name, studentLastName: student.lastName, studentGrade: student.grade})">Details</button>
